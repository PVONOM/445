...
public class Assig4Test {
	...
	public static void main(String[] args) {
		...
		Integer test = theS.deleteHead();
		System.out.println(test);
		System.out.println();
		test = theS.deleteHead();
		System.out.println(test);
		System.out.println();
		test = theS.deleteHead();
		System.out.println(test);
		...
		SequenceInterface<Character> sentencess = new HashDS<>();
		String sssss = "algorithms and dat";
		for (Character c : sssss.toCharArray()) {
			sentencess.append(c);
		}
		System.out.println(sentencess);
		System.out.println("The first letter is " + sentencess.first());
		System.out.println("The last letter is " + sentencess.last());
